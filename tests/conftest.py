    ...
    for i in range(5):
        events.append((
            ParsedEvent(
                ...
                fields={"event_type": "auth_success", "auth_method": "password", "port": 50000 + i},
                src_ip="10.0.0.1",
                username="admin",
                service="sshd",
    ...
    for i in range(5):
        events.append((
            ParsedEvent(
                ...
                fields={"event_type": "auth_failure", "auth_method": "password", "port": 60000 + i},
                src_ip="192.168.1.50",
                username="root",
                service="sshd",
    ...
    for i in range(3):
        events.append((
            ParsedEvent(
                ...
                fields={"event_type": "connection", "port": 70000 + i},
                src_ip=f"172.16.0.{i}",
                service="sshd",
    ...
    for i in range(3):
        events.append((
            ParsedEvent(
                ...
                event_type="auth_failure",
                fields={"event_type": "auth_failure", "pattern": "auth_failed_password"},
                src_ip="192.168.1.50",
                username="root",
                service="sshd",
                session_id=f"192.168.1.50:{60000 + i}",
